...
const CarDetails = () => {
  ...
  const addToCart = () => {
   fetch(`https://car-gladge-server-600enke9u-omar-faruks-projects.vercel.app/brandproducts/cartcollection`,{
    method: 'POST',
    headers: {
      ...
      <div className="card card-compact bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <p>
            ...
            <button onClick={addToCart} className="btn h-5 w-1/2 mx-auto btn-primary">Add to cart</button>
        </div>
      </div>
    </div>
  );
