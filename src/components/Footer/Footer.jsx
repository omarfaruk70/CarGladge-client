const Footer = () => {
    return (
        <div>
        <footer className="footer p-10 bg-base-200 text-base-content mt-48">
        <nav>
            <img className="w-52 md:w-72 md:h-52 rounded-t-3xl rounded-b-lg" src="https://i.ibb.co/m88tMqF/24489871-6937176.jpg" alt="Brand image" />
        </nav>
        <nav>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
        <aside className="items-center grid-flow-col">
          ...
          <p>CARGLADGE Industries Ltd. <br/>Providing reliable car since 1992</p>
        </aside> 
