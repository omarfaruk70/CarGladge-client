              ...
              <div className="card lg:w-96 glass">
                ...
                <div className="card-body">
                  ...
                  <div className="card-actions justify-center">
                    <button onClick={() => handleDeletefromMycart(data._id)} className="btn bg-red-500 hover:bg-red-600 text-white">Delete <AiFillDelete  className="font-bold text-xl"/> </button>
                  </div>
                </div>
              </div>
            </div>
